...
function sc_display_input_form() 
{
    ...
    printf ("<input type=\"submit\" name=\"submitted\" value=\"Generate Chart\" class=\"button green medium\" onclick=\"res=sc_checkdatesok(document.getElementById('dob1'), document.getElementById('time1'),'%s', '%s'); return(res);\">",$dateinputstyle,$timedisplaystyle);
    printf ("</td></tr>");
    printf ("</table>");
    printf ("</form>");
    printf ("</body>");
...
/*
            if (IMPLEMENTATION == "STANDARD")
                printf ("<tr><td><img class=\"responsive\" style=\"display:block;\" src=\"%s\"></img></td></tr>",$keyid1);
*/
            printf ("</table>");
            if (IMPLEMENTATION == "WORDPRESS" || IMPLEMENTATION == "STANDARD")
            {
/*
                printf ("<div class=\"shiftleft\">");
*/
...
/*
                printf ("<td class=\"planetpointsindexcolheader\" style=\"padding:5px; padding-bottom:15px\">Planet</td>");
*/
...
/*
                printf ("<td class=\"planetpointsindexcolheader\" style=\"padding:5px; padding-bottom:15px\">Sign</td>");
*/
...
/*
                    printf ("<td style=\"padding:5px;\">%s</td>", ucwords(strtolower($planet["name"])));
*/
...
/*
                    printf ("<td style=\"padding:3px;\">%s</td>", ucwords(strtolower($planet["signname"])));
*/
...
/*
                printf ("<td class=\"planetaspectsindexcolheader\" style=\"padding:3px; padding-bottom:15px\">Planet</td>");
*/
                printf ("<td class=\"planetaspectsindexcolheader\" style=\"padding:3px; padding-bottom:15px; font-size:100%%\">Aspect</td>");
/*
                printf ("<td class=\"planetaspectsindexcolheader\" style=\"padding:3px; padding-bottom:15px\">Aspect</td>");
*/
                printf ("<td class=\"planetaspectsindexcolheader\" style=\"padding:3px; padding-bottom:15px; font-size:100%%\">Planet</td>");
/*
                printf ("<td class=\"planetaspectsindexcolheader\" style=\"padding:3px; padding-bottom:15px\">Planet</td>");
...
/*
                    printf ("<td style=\"padding:5px;\">%s</td>", ucwords(strtolower($aspect["planeta"])));
*/
...
/*
                    printf ("<td style=\"padding:5px;\">%s</td>", ucwords(strtolower($aspect["name"])));
*/
...
/*
                    printf ("<td style=\"padding:5px;\">%s</td>", ucwords(strtolower($aspect["planetb"])));
*/
                    printf ("</tr>");
                }
                printf ("</table>");
...
*/
            ...
            printf ("<tr><td style=\"text-align:center;\"><a style=\"color:white\" class=\"button medium green\" href=\"\">Another Person</a>");
            ...
            if ((int) $returnxmlstring->rowsreturned)
            {
                ...
                printf ("<a style=\"color:white\" class=\"button medium green\" href=\"%s\">Full Report</a></td>",$reportentry_link);
            }
            printf ("</tr>");
            printf ("</table>");
            printf ("</body>");
