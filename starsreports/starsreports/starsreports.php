...
function sr_display_input_form() 
{
    ...
    else
    {
        ...
        $displaytitles = TRUE;
        if ($reporttype == 'SYNASTRY' || $reporttype == 'STARMATCH')
        {
            for ($count = 0; $count < $num_reports; $count++)
            {
                $cur_reporttype = $returnxmlstring->paramvalue[$count];
                ...
                if ($reporttype != $cur_reporttype)
                {
                    if ($cur_reporttype == 'SYNASTRY' || $cur_reporttype == 'STARMATCH')
                    {
                        if ($displaytitles)
                        {
                            printf ("<tr>");
                        ...
                        if (in_array($cur_reporttype,$_POST['extraboth']))
                            printf (" checked");
        ...
        for ($count = 0; $count < $num_reports; $count++)
        {
            ...
            if ($reporttype != $cur_reporttype)
            {
                if ($cur_reporttype != 'SYNASTRY' && $cur_reporttype != 'STARMATCH')
                {
                    ...
                    if (in_array($cur_reporttype,$_POST['extrauser0']))
                        printf (" checked");
                    ...
                    {
                        printf ("<td style=\"text-align:center\"><input");
                        if (in_array($cur_reporttype,$_POST['extrauser1']))
                            printf (" checked");
                        if ($cur_reporttype == 'SOLAR RETURN')
                        {
