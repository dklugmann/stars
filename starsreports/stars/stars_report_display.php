...
<html>
<head>
<link rel="stylesheet" type="text/css" href="stars.css?<?php echo time(); ?>">
...
<?
   ...
   if ($reporttype == 'SYNASTRY' || $reporttype == 'STARATCH')
      $user = 'both';
   else
      $user = '1';
...
/*
 ...
 printf ("<div style=\"float:left; margin-top:0px; margin-left:auto; margin-right:auto; padding-left:20px; max-width:700px; text-align:justify\">");
*/
   ...
   foreach ($report->sections[0]->section as $chapter)
   {
       ...
       $chapter->content = str_ireplace("<![CDATA[","",$chapter->content );
       ...
       $chapter->content = preg_replace("/<title>/","<span class=\"title\">",$chapter->content );
       $chapter->content= preg_replace("/<\/title>/","</span>",$chapter->content );
